        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-end">
          ...
          >
            ...
            <p className="text-secondary dark:text-zinc-400 text-sm md:text-base leading-relaxed max-w-2xl mb-8">
              Gia nhập VDCD Group để cùng xây dựng hệ sinh thái công nghệ tiên
              phong, đưa các giải pháp đổi mới sáng tạo vào phục vụ phát triển
              kinh tế bền vững tại khu vực Tây Nguyên.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              <a
                ...
                aria-label="Xem các vị trí tuyển dụng"
              >
                Xem vị trí
              ...
              <Link
                ...
                aria-label="Tìm hiểu về VDCD Group"
              >
                Về chúng tôi
